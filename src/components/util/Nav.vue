<template>
  <nav class="flex flex-row justify-between content-center items-center w-screen py-8 px-6 md:px-12 bg-dark text-gray-200" v-if="this.$route.name !== 'Signin'">
    ...
    <div class="self-center flex-1 -mr-16 -ml-2 text-2xl sm:text-4xl font-normal uppercase text-gray-300 lucky-font">
      {{ this.$route.name }}
    </div>
    <div class="flex flex-row justify-center items-center space-x-8 text-2xl">
      <i class="fas fa-user-alt text-gray-300 hidden md:block"></i>
